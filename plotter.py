...
def plot_trajectories(kf_traj, traj_name, imu, imu_ref, do_reconstruct=False):
    if do_reconstruct:
    ...
    imu_axes = kf_traj.plot_imu('img/kf_' + traj_name + '_imu.png', min_t=min_t, max_t=maxt, imu_ref=imu_ref, imu_recon=imu_recon)
