...
probe_fwkin_str = ["B_p_CB", "R_BC", "BB_v_CB", "B_om_CB", "B_acc_CB", "B_alp_CB"]
...
notchdofs = casadi.vertcat(dofs_cas_list[6], dofs_cas_list[14], dofs_cas_list[22])
...
err_notchdofs = casadi.vertcat(
    err_dofs_cas_list[6], err_dofs_cas_list[14], err_dofs_cas_list[22]
)
